...
(function() {
  ...
  Calendar.parseMonth = function (m) {
    var i = -1;
    i = i != -1 ? i : months.indexOf(m);
    i = i != -1 ? i : this.consts.monthNames.indexOf(m);
    if (i == -1) throw new CalendarException("month name not recognized")
    return i
  };
